...
#xcodebuild archive -scheme ${FRAMEWORK_NAME} -destination="watchOS" -archivePath "${IOS_DEVICE_ARCHIVE_PATH}" -sdk watchos SKIP_INSTALL=NO BUILD_LIBRARIES_FOR_DISTRIBUTION=YES
